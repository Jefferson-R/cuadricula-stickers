...
export const files = document.querySelector('#files')
export const typeImage = document.querySelector('#type-image')
export const format = document.querySelector('#formats')
export const optionalFormat = document.querySelector('#formats #optional')
